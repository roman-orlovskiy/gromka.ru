<template>
  <div class="demo">
    ...
    <transition name="fade">
      <div class="demo__layer" v-if="isLayerVisible">
        <div class="demo__close-button" @click="handleCloseLayer">
          <CloseIcon />
        </div>

        <transition name="fade">
          <div class="demo__instructions" v-if="isInstructionVisible">
            <div class="demo__instruction-item">
              <div>
                <div class="demo__instruction-number">1</div>
              </div>
